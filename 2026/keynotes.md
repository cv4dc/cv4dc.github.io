...
<tr class="bg-dark text-light">
   <th colspan="2"  style="text-align:center;"><h3>{% if keynote.url %}<a class="text-light" href="{{keynote.url}}" target="_blank">{{keynote.name}}</a>{% else %}{{keynote.name}}{% endif %}</h3>
   </th>
</tr>
<tr></tr>
<tr>
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="container-fluid">
							<img class="rounded mx-auto d-block" style="margin:auto;" src="{{site.url}}/{{keynote.image}}" alt="{{keynote.name}} - Keynote Speaker at #CV4DC 2026" style="height:200px;float: right;margin:10px;"/>
				</div>
			</div>
			{% endif %}
			<div class="{% if keynote.image %}col-sm-9{% else %}col-sm-12{% endif %}">
